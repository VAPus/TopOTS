...
if(is_logged())
{
	...
	echo '<h2>PayPal shop system</h2><br><b>Here are the steps you need to make:</b><br>
	...
	5. After the transaction points will be manually added to your account.<br>
<b>	6. Send your username on TOP-OTS and the email you donated from to amiroslo@hotmail.com to get the points</b><br><br />';
	...
	foreach($paypals as $paypal)
	{
		...
		<input type="hidden" name="custom" value="' . $_SESSION['account']['id'] . '">
